...
Noise10PercDF <- rbind(data.frame(createROCFrame(ResnoNoise, 2, posControlList), method="K-Means"),
                       data.frame(createROCFrame(ResnoNoise, 3, posControlList), method="Cox Regression"),
                       data.frame(createROCFrame(ResnoNoise, 4, posControlList), method="Median"),
                       data.frame(createROCFrame(ResnoNoise, 5, posControlList), method="Quantile 25th-75th"),
                       data.frame(createROCFrame(ResnoNoise, 7, posControlList), method="Kaplan-Scan"),
...
Noise25PercDF <- rbind(data.frame(createROCFrame(ResnoNoise, 2, posControlList), method="K-Means"),
                       data.frame(createROCFrame(ResnoNoise, 3, posControlList), method="Cox Regression"),
                       data.frame(createROCFrame(ResnoNoise, 4, posControlList), method="Median"),
                       data.frame(createROCFrame(ResnoNoise, 5, posControlList), method="Quantile 25th-75th"),
                       data.frame(createROCFrame(ResnoNoise, 7, posControlList), method="Kaplan-Scan"),
...
Noise50PercDF <- rbind(data.frame(createROCFrame(ResnoNoise, 2, posControlList), method="K-Means"),
                       data.frame(createROCFrame(ResnoNoise, 3, posControlList), method="Cox Regression"),
                       data.frame(createROCFrame(ResnoNoise, 4, posControlList), method="Median"),
                       data.frame(createROCFrame(ResnoNoise, 5, posControlList), method="Quantile 25th-75th"),
                       data.frame(createROCFrame(ResnoNoise, 7, posControlList), method="Kaplan-Scan"),
...
Noise75PercDF <- rbind(data.frame(createROCFrame(ResnoNoise, 2, posControlList), method="K-Means"),
                       data.frame(createROCFrame(ResnoNoise, 3, posControlList), method="Cox Regression"),
                       data.frame(createROCFrame(ResnoNoise, 4, posControlList), method="Median"),
                       data.frame(createROCFrame(ResnoNoise, 5, posControlList), method="Quantile 25th-75th"),
                       data.frame(createROCFrame(ResnoNoise, 7, posControlList), method="Kaplan-Scan"),
...
Noise100PercDF <- rbind(data.frame(createROCFrame(ResnoNoise, 2, posControlList), method="K-Means"),
                        data.frame(createROCFrame(ResnoNoise, 3, posControlList), method="Cox Regression"),
                        data.frame(createROCFrame(ResnoNoise, 4, posControlList), method="Median"),
                        data.frame(createROCFrame(ResnoNoise, 5, posControlList), method="Quantile 25th-75th"),
                        data.frame(createROCFrame(ResnoNoise, 7, posControlList), method="Kaplan-Scan"),
...
Noise150PercDF <- rbind(data.frame(createROCFrame(ResnoNoise, 2, posControlList), method="K-Means"),
                        data.frame(createROCFrame(ResnoNoise, 3, posControlList), method="Cox Regression"),
                        data.frame(createROCFrame(ResnoNoise, 4, posControlList), method="Median"),
                        data.frame(createROCFrame(ResnoNoise, 5, posControlList), method="Quantile 25th-75th"),
                        data.frame(createROCFrame(ResnoNoise, 7, posControlList), method="Kaplan-Scan"),
